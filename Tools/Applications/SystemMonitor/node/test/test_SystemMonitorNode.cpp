...
std::string unittest_nodename = "nodeSystemMonitor";
...
TEST(SystemMonitorNode, TestBasics) {
    ros::NodeHandle nh("~");
    ...
    sleep(1.0);  // Wait for SystemMonitorNode to Start.
...
int main(int argc, char** argv) {
    ...
    ros::init(argc, argv, "test_SystemMonitorNode");
