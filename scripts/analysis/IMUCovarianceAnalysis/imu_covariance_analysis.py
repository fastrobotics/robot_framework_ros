...
def run_analysis(data_series, save_output=False, plotting_enabled=False,output_dir="~/tmp/output"):
    ...
    if(data_series["imu"] is None or len(data_series["imu"]) == 0):
        ...
        print("IMU Data Duration: {:.2f} seconds".format(imu_duration))
        print("IMU Data Average Frequency: {:.2f} Hz".format(imu_average_frequency))
        ...
        print(orientation_covariance_matrix)
    ...
    if(data_series["magnetic"] is None or len(data_series["magnetic"]) == 0):
        ...
        print("Magnetic Data Duration: {:.2f} seconds".format(magnetic_duration))
        print("Magnetic Data Average Frequency: {:.2f} Hz".format(magnetic_average_frequency))
        ...
        print(magnetic_covariance_matrix)
...
def main():
    ...
    run_analysis(data_series,opts.save_output,opts.plotting_enabled,opts.output_dir)
